            ...
            <form action="{{ route('vehiculos.update', $vehiculo->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        type="text" id="marca" name="marca" value="{{ $vehiculo->marca }}" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        type="text" id="modelo" name="modelo" value="{{ $vehiculo->modelo }}" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        type="text" id="patente" name="patente" value="{{ $vehiculo->patente }}" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        value="{{ $vehiculo->numero_identificacion }}">
                </div>

                @php
                    $choferNombre = $vehiculo->chofer ? $vehiculo->chofer->nombre . ' ' . $vehiculo->chofer->apellido . ' - DNI ' . ($vehiculo->chofer->dni ?? $vehiculo->chofer->legajo) : '';
                @endphp
                <div x-data="{ choferInput: '{{ $choferNombre }}' }" class="mb-4">
                    ...
                    <input type="hidden" id="chofer_id" name="id_chofer" value="{{ $vehiculo->id_chofer }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        @foreach ($centroCostos as $centro)
                            <option value="{{ $centro->id }}" {{ $vehiculo->id_centro_costo == $centro->id ? 'selected' : '' }}>
                                {{ $centro->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div x-data="{ preview: '{{ $vehiculo->foto ? asset('images/' . $vehiculo->foto) : '' }}' }" class="mb-4">
