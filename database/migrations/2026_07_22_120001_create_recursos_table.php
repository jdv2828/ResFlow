...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('recursos', function (Blueprint $table) {
            ...
            $table->foreignId('emitido_por')->nullable()->constrained('users')->cascadeOnUpdate()->nullOnDelete();
            $table->foreignId('finalizado_por')->nullable()->constrained('users')->cascadeOnUpdate()->nullOnDelete();
